...
#define __PYX_HAVE__loop_cython
#define __PYX_HAVE_API__loop_cython
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'loop_cython' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "loop_cython"
int __pyx_module_is_main_loop_cython = 0;

/* Implementation of 'loop_cython' */
 ...
 * cdef double sum2d(np.ndarray[np.float32_t, ndim=2] arr):             # <<<<<<<<<<<<<<
 *     cdef int n, m
 *     n = arr.shape[0]
 */

static double __pyx_f_11loop_cython_sum2d(PyArrayObject *__pyx_v_arr) {
  int __pyx_v_n;
  int __pyx_v_m;
  double __pyx_v_ret;
  int __pyx_v_i;
 ...
 */
  ...
  __Pyx_WriteUnraisable("loop_cython.sum2d", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_arr.rcbuffer->pybuffer);
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initloop_cython(void); /*proto*/
PyMODINIT_FUNC initloop_cython(void)
#else
PyMODINIT_FUNC PyInit_loop_cython(void); /*proto*/
PyMODINIT_FUNC PyInit_loop_cython(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_loop_cython(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("loop_cython", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_loop_cython) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "loop_cython")) {
      if (unlikely(PyDict_SetItemString(modules, "loop_cython", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init loop_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init loop_cython");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
